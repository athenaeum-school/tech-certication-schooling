...
import com.as.cert.web.security.ApplicationConversionServiceFactoryBean;
...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Authority, String> ApplicationConversionServiceFactoryBean.getAuthorityToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<com.as.cert.domain.security.Authority, java.lang.String>() {
    ...
    public Converter<Long, Authority> ApplicationConversionServiceFactoryBean.getIdToAuthorityConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, com.as.cert.domain.security.Authority>() {
            public com.as.cert.domain.security.Authority convert(java.lang.Long id) {
    ...
    public Converter<String, Authority> ApplicationConversionServiceFactoryBean.getStringToAuthorityConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.as.cert.domain.security.Authority>() {
            public com.as.cert.domain.security.Authority convert(String id) {
    ...
    public Converter<AuthorityPrincipalAssignment, String> ApplicationConversionServiceFactoryBean.getAuthorityPrincipalAssignmentToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<com.as.cert.domain.security.AuthorityPrincipalAssignment, java.lang.String>() {
    ...
    public Converter<Long, AuthorityPrincipalAssignment> ApplicationConversionServiceFactoryBean.getIdToAuthorityPrincipalAssignmentConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, com.as.cert.domain.security.AuthorityPrincipalAssignment>() {
            public com.as.cert.domain.security.AuthorityPrincipalAssignment convert(java.lang.Long id) {
    ...
    public Converter<String, AuthorityPrincipalAssignment> ApplicationConversionServiceFactoryBean.getStringToAuthorityPrincipalAssignmentConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.as.cert.domain.security.AuthorityPrincipalAssignment>() {
            public com.as.cert.domain.security.AuthorityPrincipalAssignment convert(String id) {
    ...
    public Converter<Principal, String> ApplicationConversionServiceFactoryBean.getPrincipalToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<com.as.cert.domain.security.Principal, java.lang.String>() {
            public String convert(Principal principal) {
                return new StringBuilder().append(principal.getPassword()).toString();
            }
        };
    }
    
    public Converter<Long, Principal> ApplicationConversionServiceFactoryBean.getIdToPrincipalConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, com.as.cert.domain.security.Principal>() {
            public com.as.cert.domain.security.Principal convert(java.lang.Long id) {
    ...
    public Converter<String, Principal> ApplicationConversionServiceFactoryBean.getStringToPrincipalConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, com.as.cert.domain.security.Principal>() {
            public com.as.cert.domain.security.Principal convert(String id) {
