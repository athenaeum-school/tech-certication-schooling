...
@Transactional
@RooIntegrationTest(entity = CourseDetail.class)
public class CourseDetailIntegrationTest {
	...
	@Autowired
    CourseDetailDataOnDemand dod;

	@Test
    public void testCountCourseDetails() {
	...
	@Test
    public void testFindCourseDetail() {
	...
	@Test
    public void testFindAllCourseDetails() {
        Assert.assertNotNull("Data on demand for 'CourseDetail' failed to initialize correctly", dod.getRandomCourseDetail());
        long count = CourseDetail.countCourseDetails();
	...
	@Test
    public void testFindCourseDetailEntries() {
        Assert.assertNotNull("Data on demand for 'CourseDetail' failed to initialize correctly", dod.getRandomCourseDetail());
        long count = CourseDetail.countCourseDetails();
